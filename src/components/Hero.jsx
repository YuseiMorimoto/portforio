...
const Hero = () => (
  ...
  >
    ...
    >
      ...
      >
        <img src={discount} alt="discount" className="w-[32px] h-[32p]" />
        <p className={`${styles.paragraph} ml-2 text-gray-300`}>
      ...
      >
        <h1
          ...
          font-semibold sm:text-[72px] text-[52px]
         text-white sm:leading-[100px] leading-[75px]"
        >
      ...
      <h1
        className="flex-1 font-poppins
        font-semibold sm:text-[68px] text-[52px]
      text-white sm:leading-[100px] leading-[75px] w-full"
      >
        Payment Method.
      </h1>
      <p className="text-gray-300 max-w-[470px] mt-5">
        Our team of experts uses a methodology to identify <br />
        the credit card most likely to fit your needs. <br />
        We example annual percentage rates, annual fees.
      </p>
    </div>
    ...
    >
      ...
      <div
        ...
        top-0 bottom-40 white__gradient"
      />
      <div
